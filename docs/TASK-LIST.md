...
|------|---------|--------|------|----------|----------|
| P1-25 | 移动端练习记录 | P2 | 1天 | P1-24 ✅ | [📖 方案](../docs/impl/phase1-P1-22-to-P1-26-mobile.md) |
...
| 5 | P1-08 | 练习生成失败重试 | P2 | [方案](../docs/impl/phase1-P1-08-retry-mechanism.md) | [报告](../docs/dev/P1-08-练习生成失败重试.md) | [审查](../docs/review/P1-08-练习生成失败重试-review.md) | ✅ 已提交 |
| 6 | P1-09 | 练习废弃状态处理 | P2 | [方案](../docs/impl/phase1-P1-09-abandoned-status.md) | [报告](../docs/dev/P1-09-练习废弃状态处理.md) | [审查](../docs/review/P1-09-练习废弃状态处理-review.md) | ✅ 已提交 |
...
| 8 | P1-13 | 基础难度调整 | P2 | [方案](../docs/impl/phase1-P1-13-difficulty-adjust.md) | [报告](../docs/dev/P1-13-基础难度调整.md) | [审查](../docs/review/P1-13-基础难度调整-review.md) | ✅ 已提交 |
...
| 13 | P1-24 | 移动端答题界面 | P1 | [方案](../docs/impl/phase1-P1-22-to-P1-26-mobile.md) | [报告](../docs/dev/P1-24-移动端答题界面.md) | [审查](../docs/review/P1-24-移动端答题界面-review.md) | ✅ 已提交 |
| 14 | P1-25 | 移动端练习记录 | P2 | [方案](../docs/impl/phase1-P1-22-to-P1-26-mobile.md) | — | — | 🔨 **待执行** |
