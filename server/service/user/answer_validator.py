...
class AnswerValidator:
    ...
    def validate_answer(self, question_type: str, user_answer: str, correct_answer: str, 
    ...
    async def _validate_subjective_answer(self, user_answer: str, correct_answer: str, 
                                        question_content: str) -> Dict[str, Any]:
        """验证主观题答案（使用AI评分）"""
        try:
            prompt = f"""
