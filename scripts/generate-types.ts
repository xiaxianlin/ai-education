...
const OUTPUT_PATH = path.join(__dirname, '../packages/shared-frontend/src/types/api/index.ts');
 ...
 * 
 * 使用方法:
 * import type { paths, components } from '@ai-education/shared-frontend/types/api';
 */
