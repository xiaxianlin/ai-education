...
import { practiceApi, PracticeSessionDetail, Question, PracticeReport } from '@/services/practice';
...
export function UnitPracticeSession() {
  ...
  const handleCompletePractice = async () => {
    ...
    try {
      setSubmitting(true);
      const report = await practiceApi.completePractice(sessionData.session.id);
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50/50 via-purple-50/50 to-pink-50/50 pb-20">
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600">{practiceReport.unit_name}</p>
          </div>
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <div className="space-y-3">
                {Object.entries(practiceReport.knowledge_scores).map(([knowledge, score]) => (
          ...
          <div className="flex gap-3">
            <Button variant="outline" onClick={() => navigate('/unit-practice')} className="flex-1">
              返回单元列表
            </Button>
          ...
          <CardContent className="pt-6 pb-6">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-800">{sessionData.unit.name}</span>
              </div>
            ...
            <div className="mt-2 flex items-center justify-between text-sm text-gray-600">
              ...
              <span>
                剩余：{totalQuestions - currentQuestionIndex - 1} 题
              </span>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6 pb-6 space-y-6">
            ...
            <div className="flex gap-3 pt-4 border-t">
              ...
              {!hasAnswered ? (
                ...
                <Button onClick={handleCompletePractice} disabled={submitting} className="flex-1 bg-green-500 hover:bg-green-600">
