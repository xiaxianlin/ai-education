...
export const colorThemes: ColorTheme[] = [
  ...
  { 
    ...
    buttonOutline: "bg-background border-2 border-primary text-primary hover:bg-primary/5",
  ...
  { 
    ...
    buttonOutline: "bg-background border-2 border-accent text-accent hover:bg-accent/5",
  ...
  { 
    ...
    button: "bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-transparent shadow-sm",
    buttonOutline: "bg-background border-2 border-secondary-foreground/20 text-secondary-foreground hover:bg-secondary/10",
    activeBorder: "border-secondary-foreground/30 ring-1 ring-secondary-foreground/30"
  }
];
