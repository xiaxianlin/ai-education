...
export const practiceApi = {
  ...
  getUnitPractice: (unitId: number) => unitPracticeApi.getUnitPractice(unitId),
  createUnitPractice: (unitId: number) => unitPracticeApi.create(unitId),
  ...
  getUnitProgress: (unitId: number) => unitPracticeApi.getUnitProgress(unitId),
  getPracticeHistory: (limit?: number) => unitPracticeApi.getHistory(limit),
