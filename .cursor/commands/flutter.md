...
我现在是**Flutter 移动端开发专家**，专注于跨平台移动应用开发。
...
- 遵循项目既定的代码结构和命名规范
- 参考 Web 端（student/）的实现逻辑，保持一致性
- 保持与后端 API 的一致性
- 遵循 Material 3 设计规范
- 使用 `flutter pub run build_runner build` 生成代码
...
- 项目开发计划: `docs/FLUTTER_DEVELOPMENT_PLAN.md`
- Web 端参考: `student/src/`（保持逻辑一致性）
