...
export const PracticingCard = ({ unit, practice }: PracticingCardProps) => {
  ...
  return (
    <Card className="relative overflow-hidden border-2 transition-all duration-300 hover:shadow-lg hover:bg-primary/5 rounded-2xl bg-card">
