...
export const ReportSummary: FC<ReportSummaryProps> = ({
  ...
  const accuracy =
    total_questions > 0
      ? Math.round((correct_questions / total_questions) * 100)
      : 0;
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-destructive/10 rounded-2xl p-4 border-2 border-destructive/20">
              ...
              <div className="text-xs text-destructive/80 text-center mt-1">
                错误题数
              </div>
            </div>
            <div className="bg-primary/10 rounded-2xl p-4 border-2 border-primary/20">
              ...
              <div className="text-xs text-primary/80 text-center mt-1">
                总分
              </div>
            </div>
            <div className="bg-secondary/10 rounded-2xl p-4 border-2 border-secondary/20">
              ...
              <div className="text-xs text-secondary-foreground/80 text-center mt-1">
                总用时
              </div>
            </div>
          </div>
