...
from task.models.task import TaskRequest, TaskResponse, TaskStatus, TaskType
    ...
    def get_task_status(self, task_id: str) -> Optional[TaskResponse]:
        ...
        try:
            ...
            task_response = TaskResponse(
                ...
                processing_time=job.ended_at.timestamp() - job.started_at.timestamp() if (job.started_at and job.ended_at) else None,
            )
