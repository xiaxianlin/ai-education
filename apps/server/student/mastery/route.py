...
from shared.core.database import AbilityAtomic, Database, StudentAbilityMastery
...
@mastery_router.get(
    ...
    tags=["掌握度"],
    summary="获取能力掌握度概览",
    description="获取学生能力掌握度的整体概览，按能力域分组统计",
)
async def get_mastery_summary(
    ...
    domain_stats = [
        DomainMasterySchema(
            ...
            domain_name=row.domain_code,  # 可以后续关联 AbilityDomain 获取名称
