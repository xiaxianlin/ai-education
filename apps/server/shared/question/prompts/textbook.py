...
| 难度 | 数量 | 学习目标 | 推荐题型 |
|:----:|:----:|:---------|:---------|
| 简单 | **{simple_count}** | 基础巩固、建立信心 | 看图选词、听音选词、单词拼读 |
| 普通 | **{medium_count}** | 应用能力、掌握重点 | 句型填空、词序重组、听音写单词 |
| 困难 | **{hard_count}** | 综合运用、思维拓展 | 单词翻译、看图写单词、角色扮演对话 |
...
```
- **看图选词/看图选句**：需要图片资源，resource_type 为 "image"
- **句型填空/词序重组**：考查语法和句型结构
...
**口语题**：
- **单词拼读/句子拼读**：`resource_content` 填写标准单词或句子
- **听题回答/看图回答/角色扮演对话**：描述场景，提供对话内容
