...
from ai.question_generate.prompts.daily_practice import (
    ...
    SYSTEM_PROMPT as DAILY_SYSTEM,
)
from ai.question_generate.prompts.unit_practice import (
    UNIT_PRACTICE_PROMPT_ENGLISH,
    UNIT_PRACTICE_PROMPT_MATH,
    SYSTEM_PROMPT as UNIT_SYSTEM,
)
from ai.question_generate.prompts.assessment import (
    ASSESSMENT_PROMPT_ENGLISH,
    ASSESSMENT_PROMPT_MATH,
    SYSTEM_PROMPT as ASSESSMENT_SYSTEM,
)
