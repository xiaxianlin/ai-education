...
class QuestionTemplateCreateSchema(BaseModel):
    ...
    examples: Optional[List[Dict[str, Any]]] = Field(default=None, description="示例题目")
    output_schema: Optional[Dict[str, Any]] = Field(default=None, description="输出Schema")
    quality_rules: Optional[Dict[str, Any]] = Field(default=None, description="质量检查规则")
...
class QuestionTemplateSearchSchema(SearchSchema):
    """搜索题目模板"""
