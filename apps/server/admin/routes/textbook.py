...
@textbook_router.post("/knowledge", tags=["知识点管理"], summary="创建知识点", description="在系统中创建新的知识点")
...
@textbook_router.patch("/knowledge/{id}", tags=["知识点管理"], summary="更新知识点", description="更新指定知识点的信息")
...
@textbook_router.delete("/knowledge/{id}", tags=["知识点管理"], summary="删除知识点", description="删除指定的知识点")
async def delete_knowledge(id: int, db: AsyncSession = Database):
    await knowledge.delete_knowledge(db, id)


@textbook_router.get("/knowledge/search", tags=["知识点管理"], summary="搜索知识点", description="根据条件搜索知识点列表")
...
@textbook_router.patch("/unit/{id}", tags=["课程单元管理"], summary="更新课程单元", description="更新指定课程单元的信息")
...
@textbook_router.get("/unit/{id}/knowledges", tags=["课程单元管理"], summary="查询课程单元下的知识点", description="获取指定课程单元关联的所有知识点")
...
@textbook_router.post("/{id}/parse", tags=["教材管理"], summary="解析教材文件", description="对已上传的教材文件进行内容解析")
...
@textbook_router.get("/{id}/units", tags=["教材管理"], summary="根据教材ID查询课程单元", description="获取指定教材包含的所有教学单元")
