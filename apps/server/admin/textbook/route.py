...
from .services import textbook, knowledge, unit
...
@textbook_router.post(
    "/knowledge", tags=["知识点管理"], summary="创建知识点", description="在系统中创建新的知识点"
)
...
@textbook_router.patch(
    "/knowledge/{id}", tags=["知识点管理"], summary="更新知识点", description="更新指定知识点的信息"
)
...
@textbook_router.delete(
    "/knowledge/{id}", tags=["知识点管理"], summary="删除知识点", description="删除指定的知识点"
)
...
# ======================== 课程单元管理 ======================== #
@textbook_router.post(
    "/unit", tags=["课程单元管理"], summary="创建课程单元", description="为教材创建新的教学单元"
)
...
@textbook_router.delete(
    "/unit/{id}", tags=["课程单元管理"], summary="删除课程单元", description="删除指定的课程单元"
)
...
@textbook_router.post(
    "", tags=["教材管理"], summary="创建教材", description="创建一本新的教材基本信息"
)
...
@textbook_router.post(
    "/{id}/upload", tags=["教材管理"], summary="上传教材文件", description="上传教材对应的资源文件"
)
...
@textbook_router.patch(
    "/{id}", tags=["教材管理"], summary="修改教材信息", description="更新教材的元数据信息"
)
...
@textbook_router.delete(
    "/{id}", tags=["教材管理"], summary="删除教材", description="删除指定的教材及其关联数据"
)
...
@textbook_router.get(
    "/search", tags=["教材管理"], summary="搜索教材", description="根据条件查询教材列表（无分页）"
)
...
@textbook_router.get(
    "/{id}", tags=["教材管理"], summary="获取教材详情", description="获取指定教材的详细信息"
)
